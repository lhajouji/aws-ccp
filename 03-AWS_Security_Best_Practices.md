...
1. [Macie](https://aws.amazon.com/macie/) Sensitive Data
    * Helps you discover and protect sensitive data. Uses maching learning, evaluates S3 environment, uncovers PII (Personally Identifiable Information) information. 
